/**
 * Instagram and TikTok icon links. lucide no longer ships brand marks, so the
 * glyphs are inline SVG; they take currentColor so each surface sets the tone.
 */
import { SOCIAL_LINKS } from "@/lib/site";

const ICONS: Record<(typeof SOCIAL_LINKS)[number]["key"], React.ReactNode> = {
  instagram: (
