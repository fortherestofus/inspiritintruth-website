...
export const PRIVACY_SECTIONS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Giving and subscription records — the amount, date, currency and status of a gift or subscription, and whether a gift recurs. We never see or store your full card number, CVV, or bank details.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "To process gifts and subscriptions, issue receipts, and honour cancellations.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Paystack — processes gifts. Card details go directly to Paystack and never reach our servers.",
  ...
  },
  {
    ...
    body: [
      ...
      "Two exceptions: records of gifts and subscription payments are kept for as long as tax and financial law requires, and anonymised statistics that can no longer identify you may be retained.",
...
export const TERMS_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      `Recurring gifts can be changed or cancelled at any time, with no penalty. Because a gift is voluntary and nothing is supplied in return, gifts are generally non-refundable — but if you gave by mistake or something went wrong, email ${HELLO_EMAIL} and we will sort it out.`,
    ],
  },
  {
    id: "availability",
